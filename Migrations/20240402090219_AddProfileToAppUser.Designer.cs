...
namespace WebApi.Migrations
{
    ...
    [Migration("20240402090219_AddProfileToAppUser")]
    partial class AddProfileToAppUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "4a8b9313-0080-497d-8ffe-b968e5a635e6",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "e1e31693-0e9a-4e5c-ac11-5f907c0eda2a",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("WebApi.Models.Profile", b =>
                {
                    b.HasOne("WebApi.Models.AppUser", "AppUser")
                        .WithOne("Profile")
                        .HasForeignKey("WebApi.Models.Profile", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
